...
// Generated at: 2021-03-04 12:47:13
// ------------------------------------------------------------------
...
type
  IEventStreamsRPCProxy = interface
    ['{264AFD0A-C89C-4869-BD41-F37ABA825C06}']
    ...
    /// </summary>
    function EnqueueMessageTTL(const Token: string; const QueueName: string; const TTL: UInt64; Message: TJsonObject)
      : TJDOJsonObject;
    /// <summary>
    ...
    /// </summary>
    function DequeueMultipleMessage(const Token: string; const QueueName: string; LastKnownID: string;
      const MaxMessageCount: Integer; const TimeoutSec: Int64): TJDOJsonObject;
    /// <summary>
    ...
    /// Max allowed timeout is 10 minutes, min allowed timeout is 5 seconds
    /// </summary>
    function DequeueMessage(const Token: string; const QueueName: string; LastKnownID: string; const TimeoutSec: Int64)
      : TJDOJsonObject;
    /// <summary>
    ...
    /// </summary>
    function GetNextMessageByTimestamp(const Token: string; const QueueName: string; TimeStamp: TDateTime;
      IsUTC: Boolean): TJDOJsonObject;
    /// <summary>
...
function TEventStreamsRPCProxy.EnqueueMessage(const Token: string; const QueueName: string; Message: TJsonObject)
  : TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
...
function TEventStreamsRPCProxy.EnqueueMessageTTL(const Token: string; const QueueName: string; const TTL: UInt64;
  Message: TJsonObject): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TEventStreamsRPCProxy.DequeueMultipleMessage(const Token: string; const QueueName: string; LastKnownID: string;
  const MaxMessageCount: Integer; const TimeoutSec: Int64): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
...
function TEventStreamsRPCProxy.DequeueMessage(const Token: string; const QueueName: string; LastKnownID: string;
  const TimeoutSec: Int64): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TEventStreamsRPCProxy.GetNextMessageByTimestamp(const Token: string; const QueueName: string;
  TimeStamp: TDateTime; IsUTC: Boolean): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
