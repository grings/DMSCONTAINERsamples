...
uses
  ...
  LoggerPro.FileAppender, System.Classes;
...
begin
  ...
  begin
    lPart := lPart + '_' + lClientName;
  end;
  if not lComputerName.IsEmpty then
  begin
    lPart := lPart + '_' + lComputerName;
  end;
  Result := 'LOG_' + lPart + '_PID' + GetCurrentProcessID().ToString + '_' + lLogFileNameFormat;
end;
