...
// Generated at: 2020-05-05 11:30:17
//------------------------------------------------------------------
...
function TReportsRPCProxy.CreateUser(const Token: string; const aUser: TJsonObject): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TReportsRPCProxy.UpdateUser(const Token: string; const UserID: Int64; const aUser: TJsonObject): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
procedure TReportsRPCProxy.ChangePassword(const Token: string; const UserID: Int64; const NewPassword: string);
var
...
procedure TReportsRPCProxy.DisableUser(const Token: string; const UserID: Int64);
var
  lNotification: IJSONRPCNotification;
begin
...
procedure TReportsRPCProxy.EnableUser(const Token: string; const UserID: Int64);
var
  lNotification: IJSONRPCNotification;
begin
...
procedure TReportsRPCProxy.DeleteUser(const Token: string; const UserID: Int64);
var
  lNotification: IJSONRPCNotification;
begin
...
function TReportsRPCProxy.DeleteUserByUserName(const Token: string; const UserName: string): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TReportsRPCProxy.GetUser(const Token: string; const UserID: Int64): IJSONRPCResponse;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TReportsRPCProxy.GetUsers(const Token: string; const Filter: TJsonObject): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TReportsRPCProxy.CreateContext(const Token: string; const SSOContext: TJsonObject): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
procedure TReportsRPCProxy.DeleteContext(const Token: string; const SSOContextID: Int64);
var
  lNotification: IJSONRPCNotification;
begin
...
procedure TReportsRPCProxy.UpdateContext(const Token: string; const SSOContextID: Int64; const SSOContext: TJsonObject);
var
  lNotification: IJSONRPCNotification;
begin
...
function TReportsRPCProxy.GetContexts(const Token: string; const RQLFilter: string): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TReportsRPCProxy.AddContextToUser(const Token: string; const UserID: Int64; const UserContext: TJsonObject): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
procedure TReportsRPCProxy.UpdateContextToUser(const Token: string; const UserContextID: Int64; const UserContext: TJsonObject);
var
  lNotification: IJSONRPCNotification;
begin
...
function TReportsRPCProxy.GetUserContexts(const Token: string; UserID: Int64): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TReportsRPCProxy.GetUserContextsByName(const Token: string; const SSOContextName: string): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TReportsRPCProxy.GetAvailableContextsForUser(const Token: string; UserID: Int64): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
function TReportsRPCProxy.GetAvailableUsersForContext(const Token: string; ContextID: Int64): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
procedure TReportsRPCProxy.DeleteUserContext(const Token: string; const UserID: Int64; const SSOContextName: string);
var
  lNotification: IJSONRPCNotification;
begin
...
function TReportsRPCProxy.IsAuthForContext(const Token: string; SSOContextName: string): TJDOJsonObject;
var
  lReq: IJSONRPCRequest;
  lResp: IJSONRPCResponse;
begin
...
procedure TReportsRPCProxy.UpdateContextUserData(const Token: string; const UserContextID: Int64; const UserData: TJsonObject);
var
  lNotification: IJSONRPCNotification;
begin
