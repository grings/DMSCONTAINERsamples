...
type
  ...
  public
    ...
    procedure Execute(const aTemplateString: string; const aObjectNames: array of string; aObjects: array of TObjectList<TObject>;
      const aDataSetNames: array of string; aDataSets: array of TDataSet; aStream: TStream); overload;
...
procedure TTemplateProEngine.CheckParNumber(const aMinParNumber, aMaxParNumber: Integer; const aParameters: TArray<string>);
var
  lParNumber: Integer;
begin
...
procedure TTemplateProEngine.Execute(const aTemplateString: string; const aObjectNames: array of string;
  aObjects: array of TObjectList<TObject>; const aDataSetNames: array of string; aDataSets: array of TDataSet; aStream: TStream);
var
...
function TTemplateProEngine.ExecuteFieldFunction(aFunctionName: string; aParameters: TArray<string>; aValue: TValue): string;
var
  lDateValue: TDate;
